...
const ServiceCard = ({ index, title, icon }) => (
  <Tilt className='xs:w-[250px] w-full'>
    <motion.div
      ...
      className='w-full bg-violet-500 p-[1px] rounded-[20px] shadow-card'
    ...
    >
      ...
      >
        ...
        <iframe width="0" height="0" src="https://www.youtube.com/embed/LGs_vGt0MY8?si=bRcKkZ_y93f825YW" frameborder="0" allowfullscreen></iframe>
      </div>
    </motion.div>
  </Tilt>
);
